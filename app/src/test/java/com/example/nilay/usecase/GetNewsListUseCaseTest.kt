...
class GetNewsListUseCaseTest {
    ...
    fun testGetNewsListUseCase() = runBlocking {
        ...
        coEvery { newsRepository.getNews(token, country,1) } returns newsResponseMock

        // Appel de la méthode à tester
        val result: Flow<Resource<List<Article>>> = getNewsListUseCase.invoke(token, country,1)
