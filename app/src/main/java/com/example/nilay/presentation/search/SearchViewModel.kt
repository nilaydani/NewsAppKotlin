...
import com.example.nilay.domain.usecase.GetNewsListSearchUseCase
...
class SearchViewModel @Inject constructor(
    private val newsListUseCase: GetNewsListSearchUseCase
) : ViewModel() {
    ...
    fun getNews(query: String) {
        ...
        viewModelScope.launch {
            ...
            newsListUseCase(query,API_NEWS_TOKEN, _country.value,page.value)
                .collect { resource ->
